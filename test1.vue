<template>
    ...
    <update-event-modal @closeModal="closeModal" :trigger="openUpdateEventModal"  :item="selectedItem" />
    </span>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      openUpdateModal (item) {
        debugger
        this.createdUserId = item.user.uid;
        this.openUpdateEventModal = false
    ...
    mounted () {
      ...
      this.$firebase.database().ref(`events`).once('value').then((snap) => {
